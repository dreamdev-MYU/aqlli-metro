      ...
      <div className="bg-gray-50 py-2">
        <div className="container px-4 md:px-6">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span className="text-gray-900">Shahriston</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-green-50 py-8">
        <div className="container px-4 md:px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-green-600">Shahriston</h1>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Shahriston ko'chasi, Toshkent</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="text-xl font-medium text-white"> SHAHRISTON</h3>
                    ...
                    <div className="rounded-lg border p-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium">8 daqiqadan so'ng</span>
                      </div>
                    </div>
                  </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="relative h-[300px] w-full overflow-hidden rounded-lg border">
                    <iframe
                      src="https://maps.app.goo.gl/wLjdFL2xnH2y63MV8"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="rounded-lg bg-yellow-50 p-4 text-sm">
                    <p>
                      Yunusoboddan kelayotgan poyezdlar odatda o'rtacha band bo'ladi. Poyezdga chiqish va tushish
                      vaqtida ehtiyot bo'ling.
                    </p>
                  </div>
                </CardContent>
              </Card>
