...
import { Clock, Info, MapPin, AlertTriangle } from "lucide-react"
      ...
      <div className="bg-gray-50 py-2">
        <div className="container px-4 md:px-6">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <Link href="/metro/chilonzor" className="hover:text-gray-900">
              Chilonzor yo'li
            </Link>
            <span>/</span>
            <span className="text-gray-900">Buyuk Ipak Yo'li</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-red-50 py-8">
        <div className="container px-4 md:px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-red-600">Buyuk Ipak Yo'li</h1>
              <p className="mt-2 text-gray-500">Chilonzor yo'li</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Buyuk Ipak Yo'li ko'chasi, Toshkent</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      <Info className="mt-0.5 h-5 w-5 text-red-500" />
                      <div>
                    ...
                    <div className="rounded-lg bg-indigo-900 p-4 text-white">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-medium">BODOMZOR</h3>
                            <p className="text-sm text-gray-200">yo'nalishi</p>
                          </div>
                        </div>
                        <div className="text-right">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="relative h-[300px] w-full overflow-hidden rounded-lg border">
                    <iframe
                      src="https://maps.app.goo.gl/Tq8U2ZsB4UkLYgez8"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 rounded-lg border p-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">51, 93, 100</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 rounded-lg border p-3">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-500 text-white">
                        ...
                        >
                          ...
                          <path d="M6 15 9 3h7l-4 8" />
                          <path d="m9 11 3 4" />
                        </svg>
                      </div>
                      <div>
                        <h3 className="font-medium">Velosiped yo'li</h3>
                        <p className="text-sm text-gray-500">Velosiped to'xtash joyi mavjud</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="rounded-lg bg-yellow-50 p-4 text-sm">
                    <p>Paxtakor bekatiga o'tish uchun, iltimos, bekatning janubiy chiqishidan foydalaning.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
