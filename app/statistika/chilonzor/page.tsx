...
export default function ChilonzorStatisticsPage() {
  ...
  // Chilonzor line stations
  const stations = [
    { name: "Buyuk Ipak Yo'li", id: "buyuk-ipak-yoli", dailyPassengers: 26450, weeklyAvg: 25800, monthlyTotal: 774000 },
    { name: "Pushkin", id: "pushkin", dailyPassengers: 23580, weeklyAvg: 22900, monthlyTotal: 687000 },
    { name: "Hamid Olimjon", id: "hamid-olimjon", dailyPassengers: 21870, weeklyAvg: 20500, monthlyTotal: 615000 },
    { name: "Amir Temur Xiyoboni", id: "amir-temur", dailyPassengers: 29340, weeklyAvg: 28700, monthlyTotal: 861000 },
    {
      name: "Mustaqillik Maydoni",
      id: "mustaqillik-maydoni",
      dailyPassengers: 27760,
      weeklyAvg: 26900,
      monthlyTotal: 807000,
    },
    { name: "Paxtakor", id: "paxtakor", dailyPassengers: 30150, weeklyAvg: 29600, monthlyTotal: 888000 },
  ]
      ...
      <div className="relative bg-red-50 py-8">
        <div className="container px-4 md:px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-red-600">Chilonzor yo'li statistikasi</h1>
                      ...
                      {stations.map((station, index) => (
                        <div key={station.id} className="flex-1 px-1 flex flex-col items-center">
                          <div
                            ...
                            style={{ height: `${(station.dailyPassengers / 35000) * 100}%` }}
                          ></div>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Paxtakor</p>
                      </div>
                      <div className="text-right">
                        <p className="text-xl font-semibold">30,150</p>
                    ...
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-semibold">4,120</p>
                ...
                <CardContent className="p-6">
                      ...
                      {stations.map((station, index) => (
                        <div key={station.id} className="flex-1 px-1 flex flex-col items-center">
                          <div
                            ...
                            style={{ height: `${(station.weeklyAvg / 35000) * 100}%` }}
                          ></div>
                          <p className="text-xs text-center mt-2 font-medium">{station.name}</p>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-semibold text-green-600">+4.5%</p>
                        <p className="text-sm text-gray-500">yo'lovchi</p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-semibold">32,760</p>
                        <p className="text-sm text-gray-500">yo'lovchi</p>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                      ...
                      {stations.map((station, index) => (
                        <div key={station.id} className="flex-1 px-1 flex flex-col items-center">
                          <div
                            ...
                            style={{ height: `${(station.monthlyTotal / 900000) * 100}%` }}
                          ></div>
                          <p className="text-xs text-center mt-2 font-medium">{station.name}</p>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-semibold text-green-600">+6.2%</p>
                        <p className="text-sm text-gray-500">yo'lovchi</p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-xl font-semibold">25,840</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-2 w-full bg-gray-100 rounded-full">
                      <div
                        ...
                        style={{ width: `${(station.dailyPassengers / 35000) * 100}%` }}
                      ></div>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="h-2 w-full bg-gray-100 rounded-full">
                      <div
                        ...
                        style={{ width: `${(station.weeklyAvg / 35000) * 100}%` }}
                      ></div>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="h-2 w-full bg-gray-100 rounded-full">
                      <div
                        ...
                        style={{ width: `${(station.monthlyTotal / 900000) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  <div className="mt-4">
                    <Button
                      ...
                      size="sm"
                      className="w-full"
                      onClick={() => (window.location.href = `/metro/chilonzor/${station.id}`)}
                    >
                      Batafsil ma'lumot
                    </Button>
                  </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/statistika/chilonzor" className="hover:text-white">
                    Statistika
                  </Link>
                </li>
              </ul>
